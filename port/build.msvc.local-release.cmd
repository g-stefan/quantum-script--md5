...
echo -^> local-release quantum-script-extension-md5
...
call :cmdX xyo-cc quantum-script-extension-md5 --archive-release-sha512 --version-file=source/quantum-script-extension-md5.version.ini
